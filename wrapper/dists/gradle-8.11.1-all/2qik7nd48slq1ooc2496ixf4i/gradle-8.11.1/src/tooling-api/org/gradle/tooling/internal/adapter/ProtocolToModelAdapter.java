...
public class ProtocolToModelAdapter implements ObjectGraphAdapter {
    ...
    /**
     * Creates a builder for user of the given type.
     */
    @Override
    ...
    private static <T> T createView(Class<T> targetType, @Nullable Object sourceObject, ViewDecoration decoration, ViewGraphDetails graphDetails) {
        ...
        // Restrict the decorations to those required to decorate all user reachable from this type
    ...
    private static class ViewGraphDetails implements Serializable {
        // Transient, don't serialize all the user that happen to have been visited, recreate them when visited via the deserialized view
