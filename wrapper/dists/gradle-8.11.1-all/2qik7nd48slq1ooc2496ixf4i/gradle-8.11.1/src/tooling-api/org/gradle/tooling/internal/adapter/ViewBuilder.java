...
public interface ViewBuilder<T> {
    ...
    /**
     * Mixes the given object into all user of the given type created using {@link #build(Object)}.
     * Applied to all user reachable from created user. The mix-in object should be serializable.
     *
    ...
    /**
     * Mixes the given type into all user of the given type created using {@link #build(Object)}.
     * Applied to all user reachable from created user.
     *
