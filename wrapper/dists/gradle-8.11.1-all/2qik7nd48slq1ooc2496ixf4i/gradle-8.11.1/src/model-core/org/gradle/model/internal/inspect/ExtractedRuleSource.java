...
public interface ExtractedRuleSource<T> {
    ...
    /**
     * Creates a factory for creating user of this rule source, for invoking rules or binding references. Should be used only before the rule source has been applied.
     */
