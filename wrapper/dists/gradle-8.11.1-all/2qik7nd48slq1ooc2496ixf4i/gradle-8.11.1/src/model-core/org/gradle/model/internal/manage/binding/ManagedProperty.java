 ...
 * methods. This means that accessors declaring the property in the user should all be abstract, and the delegate type (if any)
 ...
 *
 * <p>Different user can declare the same getter with different return types. In such a case the type of the managed property
